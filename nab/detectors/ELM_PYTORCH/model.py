...
class ELMModel(nn.Module):
    def __init__(self,input_size=100,output_size=100,hidden_size=100,layerNorm=True,forgettingFactor=0.999):
    ...
    def forward(self, x):
        ...
        #x = Variable(torch.FloatTensor(1,100),volatile=True).cuda()
